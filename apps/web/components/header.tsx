    ...
    <header className="sticky top-0 z-30 border-b border-border/40 bg-background/85 backdrop-blur-xl supports-[backdrop-filter]:bg-background/70">
      <div className="flex h-[72px] items-center justify-between px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="gap-2 rounded-full bg-primary text-white shadow-md shadow-primary/20 transition-all duration-200 hover:bg-purple-dark hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5 active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-primary/30"
          >
          ...
          >
            ...
            <span className="absolute -right-0.5 -top-0.5 flex h-[18px] w-[18px] items-center justify-center rounded-full bg-coral text-[10px] font-bold text-white ring-2 ring-background">
              3
            </span>
          </Button>
        </div>
